...
class View {
    ...
    public function assign($name, $value = '') {
        ...
        $json = json_encode($this->tVar);
        $js = '<script type="text/javascript">var assignData=' . $json . ';'
                . 'var module="' . MODULE_NAME . '";'
                . 'var controller="' . CONTROLLER_NAME . '";'
                . 'var action="' . ACTION_NAME . '";'
                . 'var m_path="' . __ROOT__ . '/index.php/' . MODULE_NAME . '";'
                . 'var c_path="' . __ROOT__ . '/index.php/' . MODULE_NAME . '/' . CONTROLLER_NAME . '";'
                . 'var a_path="' . __ROOT__ . '/index.php/' . MODULE_NAME . '/' . CONTROLLER_NAME . '/' . ACTION_NAME . '";'
                . 'var root="' . __ROOT__ . '";'
                . 'var public="' . __ROOT__ . '/Public";'
                . 'if("'.MODULE_NAME.'"!="Seller"&&"'.MODULE_NAME.'"!="Appm"&&"'.MODULE_NAME.'"!="Dxt"&&"'.MODULE_NAME.'"!="Home"){$.post("' . __ROOT__ . '/index.php/admin/login/checkIsLogin",{"c_name":controller,"a_name":action},function (data) {'
