...
<html>
    ...
    <body>
        ...
        <header class="mui-bar mui-bar-nav header-a-l">
            <a class="mui-icon mui-icon-back mui-pull-left header-a-l" onclick="aHref('/index.php/Dxt/index/my_info')"></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploader = WebUploader.create({
            ...
            server: '/index.php/Dxt/allattach/uploadAttach/module_name/tx_app', // 文件接收服务端。
        ...
        $filelist.on('click', '.del', function (e) {
            $obj = $(this);
            $.post('/index.php/Dxt/allattach/delAttach', {'id': $(this).next().val()}, function (result) {
                if (result.code == '500') {
