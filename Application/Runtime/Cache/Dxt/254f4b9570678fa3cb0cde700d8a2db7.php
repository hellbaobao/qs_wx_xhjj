...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Public/dxt/css/top.css" type="text/css"/>
        <style type="text/css">
            .top_card_hearder{
        ...
        <script src="/Public/dxt/js/top_home.js"></script>
    </head>
    ...
    <div class="mui-content">
        <!--页面部分-->
        <div class="mui-row">
            <div class="mui-card" onclick="aHref('/index.php/Dxt/top/top_list?type=0')">
            ...
            <div class="mui-card" onclick="aHref('/index.php/Dxt/top/top_list?type=1')">
            ...
            <div class="mui-card" onclick="aHref('/index.php/Dxt/top/top_list?type=2')">
            ...
            <div class="mui-card" onclick="aHref('/index.php/Dxt/top/top_list?type=3')">
