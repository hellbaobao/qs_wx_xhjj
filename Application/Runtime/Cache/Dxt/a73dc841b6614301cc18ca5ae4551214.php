...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="/Public/dxt/js/seller_detail.js"></script>
    ...
    <body>
        ...
        <header class="mui-bar mui-bar-nav header-a-l">
            <a class="mui-icon mui-icon-back mui-pull-left header-a-l" onclick="aHref('/index.php/Dxt/SellerIntegralGoods/item_list')"></a>
            <h1 id="title" class="mui-title header-a-l">商家详情</h1>
        </header>
        ...
        <div class="mui-content" style="padding-top: 45px;background-color: #fefefe;">
            ...
            <div class="mui-card">
                <div class="mui-card-header">
                    <div class="mui-card-link"><div class="seller_s"></div><?php echo ($sellerInfo["name"]); ?></div>
                    ...
                    <div class="mui-card-content-inner">
                        <div class="item_list">
                            <div class="item_list_word">
                                <span class="font16">地址：<?php echo ($sellerInfo["address"]); ?></span>
                            </div>
            ...
            <div class="mui-card">
                ...
                <div class="mui-card-content">
                    <div id="goods-lists">
                        ...
                        <!--列表非空-->
                        <?php if(!empty($goodsList)): if(is_array($goodsList)): foreach($goodsList as $k=>$v): ?><div class="mui-card" onclick="aHref('/index.php/Dxt/SellerIntegralGoods/goods_detail?id=<?php echo ($v["id"]); ?>')">
                                    <div class="mui-card-content">
                                        <div class="item_list">
