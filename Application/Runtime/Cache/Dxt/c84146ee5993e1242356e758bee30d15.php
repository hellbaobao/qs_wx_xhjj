...
<html>
    ...
    <head>
        ...
        <script src="/Public/dxt/js/activity_list.js"></script>
    </head>

    <body>
        <!--头部-->
        <header class="mui-bar mui-bar-nav header-a-l">
            <h1 id="title" class="mui-title header-a-l">最新活动</h1>
    ...
    <a class="mui-tab-item" onclick="aHref('/index.php/Dxt/index/setting')" id="Index_btn">
        ...
        <!--主体-->
        <div class="mui-content" style="background-color: #fff;margin-top:10px;">
