...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="/Public/dxt/js/goods_detail.js"></script>
    </head>
    ...
    <body>
        ...
        <div class="mui-content" style="padding-top: 45px;background-color: #fefefe;">
            ...
            <div class="mui-card">
                ...
                <div class="mui-card-header" onclick="aHref('/index.php/Dxt/SellerIntegralGoods/seller_detail?id=<?php echo ($sellerInfo["id"]); ?>')">
                    <div class="mui-card-link">
                        <div class="seller_s"></div>
                        <?php echo ($sellerInfo["name"]); ?>
                    </div>
                    <button type="button" class="mui-btn-primary mui-btn-outlined">进店</button>
                </div>
