...
<html>
    <head>
        <meta charset="utf-8">
        <title>意林<?php echo ($date); ?>期</title>
    ...
    <body>
        ...
        <header class="mui-bar mui-bar-nav header-a-l">
            <h1 class="mui-title header-a-l">《意林<?php echo ($date); ?>期》</h1>	
        </header>
             ...
             <ul class="mui-table-view mui-table-view-chevron">
                <?php if(is_array($data)): foreach($data as $k=>$vo): ?><li class="mui-table-view-cell mui-media" onclick="jumpHref('<?php echo ($vo["href"]); ?>')">
                    <a class="mui-navigate-right">
                        <img class="mui-media-object mui-pull-left" src="/Public/home/img/book.png">
                        <div class="mui-media-body mui-ellipsis" style="line-height: 40px;">
                            <?php echo ($vo["title"]); ?>
                        </div>
                    </a>
...
<script type="text/javascript">
            function jumpHref(id) {
                window.open("/index.php/home/zxw/yldetail?key=" + id);
            }
