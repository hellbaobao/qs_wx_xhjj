    ...
    <body>
        ...
        <div class="container">
            <form method="post" action="#"  class="form-horizontal"  id="save-form" style="margin-top: 20px;">
                ...
                <input type="hidden" name="is_qf" value="1"/>
                <div id="fileJson" name="fileJson" style="display: none;"><?php echo ($attachList); ?></div>
                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label">链&#12288;&#12288;接</label>
                    <div class="col-sm-8">
                        <div class='input-group'>
                            <input type="text" class="form-control" id="url" name="url" value="<?php echo ($searchInfo["url"]); ?>" placeholder="请输入标题">
                            <span class='input-group-btn'>
                                <button type="button" class="btn btn-success" id="searchInfo-btn" onclick="getWxArr()" style="height: 34px;">
                                    <span class="glyphicon glyphicon-search"></span> 抓取
                                </button>
                            </span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea id="texta" name="content" style="width: 100%;height: 120px;background-color: #fff;border:1px solid #ccc;border-radius: 4px;padding: 10px;"></textarea>
