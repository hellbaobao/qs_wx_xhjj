    ...
    <body>
        ...
        <div class="container">
            <form method="post" action="#"  class="form-horizontal"  id="save-form" style="margin-top: 20px;">
                <input type="hidden" name="id" value="<?php echo ($apptlearnInfo["id"]); ?>"/>
                <div id="fileJson" name="fileJson" style="display: none;"><?php echo ($attachList); ?></div>
                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label">培训标题</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="title" name="title" value="<?php echo ($apptlearnInfo["title"]); ?>" placeholder="请输入标题">
                    </div>
                    <label class="col-sm-2"><span class="tipMsg">*必填</span></label>
                </div>
                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label">培训时间</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="start_time" name="start_time" value="<?php echo ($apptlearnInfo["start_time"]); ?>" placeholder="请输入培训时间">
                    </div>
                    <label class="col-sm-2"><span class="tipMsg">*必填</span></label>
                </div>
                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label">培训讲师</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="teacher" name="teacher" value="<?php echo ($apptlearnInfo["title"]); ?>" placeholder="请输入培训讲师">
                    </div>
                    <label class="col-sm-2"><span class="tipMsg">*必填</span></label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <button type="button" class="btn btn-warning" onclick="javascript:void(window.location.href = '/index.php/Admin/Apptlearn/showList')">取&#12288;&#12288;消</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var uploader = WebUploader.create({
                ...
                server: '/index.php/Admin/allattach/uploadAttach/module_name/apptlearn', // 文件接收服务端。
            ...
            contentEditor.ready(function () {
                contentEditor.setContent('<?php echo ($apptlearnInfo["content"]); ?>');
            });
