            ...
            <form method="get" action="/index.php/Admin/SysUserAppInfo/showList" class="form-horizontal" id="search-form" style="margin-top: 20px;">
                <div class="form-group">
                    <div class="col-sm-2" style="min-width: 200px;">
                        <button type="button" class="btn btn-success addUserAppInfo" onclick="javascript:void(window.location.href = '/index.php/Admin/SysUserAppInfo/saveUserInfo/catName/appUser')" style="height: 34px;">
                            <span class="glyphicon glyphicon-plus"></span> 新增
                        </button>
                        <button type="button" class="btn btn-danger delUserAppInfo" id="delArrayGroup-btn" style="height: 34px;">
        ...
        <div class="table_content">
            <table class="table table-hover">
                ...
                <?php if(!empty($infoList)): if(is_array($infoList)): foreach($infoList as $k=>$v): ?><tr class="tr">
                        ...
                        <td>
                            <div>
                                <button class="btn btn-default edit-btn editUserAppInfo" onclick="javascript:void(window.location.href = '/index.php/Admin/SysUserAppInfo/appUserDetail/id/<?php echo ($v["id"]); ?>');">
                                    <span class="glyphicon glyphicon-edit"></span> 编辑
                                </button>
                                <button class="btn btn-default del-btn bindingUserAppInfo" onclick="bindingCardLayer(<?php echo ($v["id"]); ?>)">
                                    <span class="glyphicon glyphicon-qrcode"></span> 绑卡
                                </button>
                                <button class="btn btn-default add-btn unbindingUserAppInfo" onclick="unBinding(<?php echo ($v["id"]); ?>)">
