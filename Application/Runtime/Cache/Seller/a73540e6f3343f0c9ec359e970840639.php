...
<html>
    <head>
        ...
        <script src="/Public/seller/js/top_list.js"></script>
    </head>

    <body>
        <!--头栏-->
        <header class="mui-bar mui-bar-nav header-a-l">
            <a class="mui-icon mui-icon-back mui-pull-left header-a-l" onclick="aHref('/index.php/Seller/top/top_home')"></a>
                        ...
                        <div class="mui-card-content-inner" id="topList">
                            <div class="mui-row row_list">
                                ...
                                <div class="row_list_tx">
                                    <img src="/Public/seller/img/tx_icon/3.jpg">
                                </div>
                            ...
                            <div class="mui-row row_list">
                                ...
                                <div class="row_list_tx">
                                    <img src="/Public/seller/img/tx_icon/4.jpg">
                                </div>
                                <span class="row_list_title">京客隆超市</br><p>云景东里社区</p></span>
                                <span class="row_list_integral">90000分</span>
                            </div>
                            <div class="mui-row row_list">
                                ...
                                <div class="row_list_tx">
                                    <img src="/Public/seller/img/tx_icon/5.jpg">
                                </div>
                                <span class="row_list_title">京客隆超市</br><p>云景东里社区</p></span>
                                <span class="row_list_integral">90000分</span>
                            </div>
