...
<html>
    ...
    <body>
        ...
        <header class="mui-bar mui-bar-nav header-a-l">
            <a class="mui-icon mui-icon-back mui-pull-left header-a-l" onclick="aHref('/index.php/Seller/seller/my_info')"></a>
            <h1 class="mui-title header-a-l">上传资质</h1>
        </header>
        ...
        <div class="mui-content" style="padding-top: 45px;background-color: #fefefe;">
            ...
            <div class="mui-row">
                ...
                <div class="mui-card">
                    <div class="mui-card-header fontred">请上传营业执照及门店照片</div>
                    <!--内容区-->
            ...
            <div id="fileJson" name="fileJson" style="display: none;"><?php echo ($allattch); ?></div>

            <?php if(is_array($zzPic)): foreach($zzPic as $key=>$v): ?><div class="mui-card">
                    <img src="../../../<?php echo ($v["file_path"]); ?>" style="width: 100%;height:auto;">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploader = WebUploader.create({
            ...
            server: '/index.php/Seller/allattach/uploadAttach/module_name/zz_seller', // 文件接收服务端。
    ...
    function subForm() {
        $.post(c_path + '/saveZzInfo', {"form_data": $('#form').serialize()}, function (result) {
            if (result.is_success.flag == 1) {
                window.location.href = c_path + '/seller_home';
            } else {
