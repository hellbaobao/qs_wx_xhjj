...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/appm/plugin/webuploader/webuploader.css">
        <style type="text/css">
            .seller_s{
        ...
        <script type="text/javascript" src="/Public/appm/plugin/webuploader/webuploader.min.js"></script>
    </head>
    ...
    <body>
        ...
        <header class="mui-bar mui-bar-nav header-a-l">
            <a class="mui-icon mui-icon-back mui-pull-left header-a-l" onclick="aHref('/index.php/Appm/index/my_info')"></a>
        ...
        <div class="mui-content" style="padding-top: 45px;background-color: #fefefe;">
            ...
            <div class="mui-card">
                <img src="<?php echo ($myInfo["tx_path"]); ?>" style="width: 100%;height:auto;">
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var uploader = WebUploader.create({
            ...
            swf: '/Public/appm/plugin/webuploader/Uploader.swf', // swf文件路径
            server: '/index.php/Appm/allattach/uploadAttach/module_name/tx_app', // 文件接收服务端。
        ...
        $filelist.on('click', '.del', function (e) {
            $obj = $(this);
            $.post('/index.php/Appm/allattach/delAttach', {'id': $(this).next().val()}, function (result) {
                if (result.code == '500') {
