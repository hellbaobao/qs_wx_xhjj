...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="/Public/appm/js/seller_detail.js"></script>
            ...
            <div class="mui-card">
                ...
                <div class="mui-card-content">
                    <div id="goods-lists">
                        ...
                        <!--列表非空-->
                        <?php if(!empty($goodsList)): if(is_array($goodsList)): foreach($goodsList as $k=>$v): ?><div class="mui-card" onclick="aHref('/index.php/Appm/SellerIntegralGoods/goods_detail?id=<?php echo ($v["id"]); ?>')">
                                    <div class="mui-card-content">
                                        <div class="item_list">
