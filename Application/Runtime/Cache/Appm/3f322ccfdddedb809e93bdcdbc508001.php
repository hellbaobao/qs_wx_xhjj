            ...
            <div class="mui-card">
                <div class="mui-card-content">
                    <div class="mui-card-content-inner" style="text-align: center;">
                        ...
                        <p>您还不是梨园智能商圈社区卡电子用户</p>
                        <button type="button" class="mui-btn mui-btn-primary mui-btn-block" onclick="aHref('/index.php/Appm/Login/apply')">快速申请</button>
                        <button type="button" class="mui-btn mui-btn-block" onclick="aHref('/index.php/Appm/Login/wechat_binding')">已有社区卡账户，立即绑定</button>
                        
                        <button type="button" class="mui-btn-danger mui-btn-block" onclick="aHref('/index.php/Appm/Login/ys')">演示帐号</button>
                    </div>
                </div>
            </div>
        </div>
