...
<html>
    <head>
        ...
        <script src="/Public/appm/js/perfect_info.js"></script>
    </head>

    <body>
        <!--头栏-->
        <header class="mui-bar mui-bar-nav header-a-l">
            <a class="mui-icon mui-icon-back mui-pull-left header-a-l" onclick="aHref('/index.php/Appm/login/apply')">
                <!--<sapn class="comfont">设置</span>-->
            </a>
            <h1 id="title" class="mui-title header-a-l">完善资料</h1>
        </header>
        <!--tab-->
        <div class="mui-content">
            ...
            <div class="mui-row">
                <button type="button" class="mui-btn mui-btn-primary mui-btn-block" onclick="saveUserInfo()">下一步</button>
            </div>
        </div>
    </body>
</html>